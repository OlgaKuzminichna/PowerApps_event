...
- **Filter Events**: On the right top there is a filter icon, by clicking there a section on the left side will appear with chance to filter the list by date, title, or event type
