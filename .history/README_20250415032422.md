...
- **Event Registration**: For each event, users can register if it is  or click to **Get Invite**. This functionality makes it easy to join events with just one click.
