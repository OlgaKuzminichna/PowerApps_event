...
- **Event Registration**: For each event, users can register if it is an external event or click to **Get Invite**, then  This functionality makes it easy to join events with just one click.
