...
- **Event Title & Type**: If you are an Admin then in the right navigation bar you will see Create event subitem, by clicking there a screen with a form will shows up, where admin can enter all information about the event and with submiting new event will be stored in sharepoint list and event will be created in outlook calendar
