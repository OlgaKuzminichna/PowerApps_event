...
- **Event Title & Type**: If you are an Admin then in the right navigation bar you will see Create event subitem, by clicking there a screen with a form will shows up, 
